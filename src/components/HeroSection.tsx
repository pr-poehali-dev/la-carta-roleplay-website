...
const HeroSection = () => {
  return (
    <section className="relative min-h-[80vh] bg-gradient-to-br from-gray-900 via-purple-900/20 to-orange-900/20 flex items-center">
      {/* Background Pattern */}
      <div className="absolute inset-0 bg-gradient-to-br from-purple-500/5 to-orange-500/5 opacity-30"></div>
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto leading-relaxed">
            Погрузитесь в мир реалистичного ролевого отыгрыша в GTA 5. Станьте
            частью уникального сообщества и создайте свою историю в Лос-Сантосе.
          </p>
